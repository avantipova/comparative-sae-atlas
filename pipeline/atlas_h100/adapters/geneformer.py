...
class GeneformerAdapter(Adapter):
    ...
    def __init__(self, ckpt="ckpt_geneformer_v2/Geneformer-V2-316M", layers=None, max_len=2048,
                 token_dict_dir="ckpt_geneformer_v2/geneformer"):
        self.ckpt = ckpt
        self._layers_override = layers            # None -> set from depth after load
        self.max_len = max_len
        self.token_dict_dir = token_dict_dir      # token_dictionary_gc104M.pkl + gene_median_dictionary_gc104M.pkl live here
