...
check("3.2 degree fold", rf"a degree-matched null {N}-fold", dig(DN, ">=8", "degree_fold"), "controls:degree_null")
...
check("2 clean models", rf"not spread\s*\n?evenly: {W} models have no dead", len(dig(SAE, "clean_models", default=[])), "sae_health")
