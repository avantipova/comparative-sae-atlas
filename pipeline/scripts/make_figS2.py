...
null_sd = [r["tiers"][">=8"]["null_sd"] for r in rows]
...
a.bar(x + w/2, null, w, color=GREY_D, label="random-gene null",
      yerr=null_sd, error_kw=dict(ecolor="#444", lw=0.9, capsize=2.5))
...
a.text(0.02, -0.16, f"×N = real ÷ random-gene null;  error bars ±1 SD over {d['n_perm']} permutations", transform=a.transAxes,
