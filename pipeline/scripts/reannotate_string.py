...
AXIS = {"AIDO": "expression (all genes)", "UCE": "ESM protein-token", "tGPT": "autoregressive rank",
        "Geneformer": "rank-MLM", "scGPT": "expr-MLM", "C2S": "cell-sentence LLM (Gemma-2-2B)", "MaxToki": "rank autoregressive (Llama)",
        "Tahoe": "expression MLM (scGPT-style, 3B)", "scFoundation": "read-depth MAE (100M)", "GeneCompass": "knowledge/GRN-prior BERT (104M)"}
PARAMS = {"AIDO": "10M", "UCE": "650M", "tGPT": "~120M", "Geneformer": "316M", "scGPT": "~50M", "C2S": "2B", "MaxToki": "217M", "Tahoe": "3B", "scFoundation": "100M", "GeneCompass": "104M"}
